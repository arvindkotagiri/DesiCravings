...
const HeroBanner1 = () => {
    ...
    const heroContent = [
        {img:'/assets/img/banner/bannerThumb1_1.png', subtitle:'Desi Cravings', title:'SPICY FRIED CHICKEN', btnname:'ORDER NOW'},
        {img:'/assets/img/banner/bannerThumb1_2.png', subtitle:'Desi Cravings', title:'Chicago Deep Pizza King', btnname:'ORDER NOW'},
        {img:'/assets/img/banner/bannerThumb1_3.png', subtitle:'Desi Cravings', title:'Chicago Deep Burger King', btnname:'ORDER NOW'},
      ]; 
